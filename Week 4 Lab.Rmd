---
title: "DS 413/613  CLASSWORK/LAB  Week 4"
...
Instructions: Generate and email an Rmarkdown file and a Word file that shows code script 
and all required output.
```{r}
x <- list(2, 4, 5, 9, 1)
y <- list(8, 7, 2, 8, 3)
z <- list(1, 8, 5, 4, 2)
...
are sums of the corresponding columns and rows. Your code should produce the matrix below:
